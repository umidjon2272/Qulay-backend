...
export const APP_ERROR_CODES = {
  ...
  WHATSAPP_SERVER_NOT_CONFIGURED: 'WHATSAPP_SERVER_NOT_CONFIGURED',
  WHATSAPP_ACCESS_TOKEN_INVALID: 'WHATSAPP_ACCESS_TOKEN_INVALID',
  WHATSAPP_PHONE_OR_WABA_INVALID: 'WHATSAPP_PHONE_OR_WABA_INVALID',
  WHATSAPP_PERMISSION_REQUIRED: 'WHATSAPP_PERMISSION_REQUIRED',
  WHATSAPP_GRAPH_UNAVAILABLE: 'WHATSAPP_GRAPH_UNAVAILABLE',
  WHATSAPP_WEBHOOK_SUBSCRIBE_FAILED: 'WHATSAPP_WEBHOOK_SUBSCRIBE_FAILED',
} as const;

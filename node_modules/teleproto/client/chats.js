...
class _AdminLogIter extends requestIter_1.RequestIter {
    async _init(entity, searchArgs, filterArgs) {
        ...
        this.request = new tl_1.Api.channels.GetAdminLog({
            ...
            minId: (_a = searchArgs === null || searchArgs === void 0 ? void 0 : searchArgs.minId) !== null && _a !== void 0 ? _a : big_integer_1.default.zero,
            maxId: (_b = searchArgs === null || searchArgs === void 0 ? void 0 : searchArgs.maxId) !== null && _b !== void 0 ? _b : big_integer_1.default.zero,
            limit: 0,

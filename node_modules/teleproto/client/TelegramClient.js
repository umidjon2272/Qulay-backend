...
const apiProxy_1 = require("../tl/runtime/apiProxy");
...
class TelegramClient extends telegramBaseClient_1.TelegramBaseClient {
    ...
    get api() {
        if (!this._apiProxy) {
            this._apiProxy = (0, apiProxy_1.createApiProxy)(tl_1.Api, (request, dcId) => this.invoke(request, dcId));
        }

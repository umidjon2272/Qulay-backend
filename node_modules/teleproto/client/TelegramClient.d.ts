...
export declare class TelegramClient extends TelegramBaseClient {
     ...
     * ```
     */
    downloadProfilePhoto(entity: EntityLike, downloadProfilePhotoParams?: downloadMethods.DownloadProfilePhotoParams | string): Promise<string | Buffer<ArrayBufferLike> | undefined>;
    /**
     ...
     * ```
     */
    downloadMedia(messageOrMedia: Api.Message | Api.TypeMessageMedia, downloadParams?: DownloadMediaInterface | string): Promise<string | Buffer<ArrayBufferLike> | undefined>;
    /**
    ...
    invokeWithSender<R extends Api.AnyRequest>(request: R, sender?: MTProtoSender | SessionLease): Promise<R["__response"]>;
    private _apiProxy?;
    /**

...
describe('Voice service', () => {
  ...
  it('creates an authenticated, bounded VAD session without enabling automatic actions', async () => {
    ...
    try {
      ...
      expect(body.session.audio.input.turn_detection).toEqual({ type: 'server_vad', threshold: 0.40, prefix_padding_ms: 180, silence_duration_ms: 240, create_response: false, interrupt_response: true });
